...
<html>
<head>
    <title>Configuracion principal del programa</title>
...
<div class="configuracion-panel">
  <h2>Configuración actual del programa:</h2>
  <%
    String configuracionMostrar = "";
    ArrayList<String> configuracion = controlador.configuracionPrograma();

    for (String linea : configuracion) {
      configuracionMostrar += linea + "\n";
    }%>
  <p><%=configuracionMostrar%></p>
</div>
<a href="index.jsp"><button class="volver-btn">Volver al inicio</button></a>
</body>
</html>
