...
<html>
<head>
    <title>Elegir al trabajador para asignar pedido</title>
...
<div class="contenedor-registros">
  ...
  <h2 class="no-registros">No se han registrado trabajadores</h2>
  <%}else{%>
  <h2>Elija al trabajador para asignar el pedido nº<%=idPedido%></h2>
  ...
  <div class="tarjeta-registro">
    ...
    <form action="procesarAsignacionPedidoTrabajador.jsp" method="post">
      <input type="hidden" name="idTrabajador" value="<%=t.getId()%>">
      <input type="hidden" name="idPedido" value="<%=idPedido%>">
      <button id="seleccion" type="submit">Asignar a este trabajador</button>
    </form>
  </div>
  <%}
  }%>
</div>
<a href="index.jsp" class="boton-volver-inicio"><button>Volver al inicio</button></a>
</body>
</html>
