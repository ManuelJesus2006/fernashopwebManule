...
<html>
<head>
    <title>Resultados de la busqueda por termino</title>
...
<%
    ...
    if (termino == null) {
        ...
        ArrayList<Producto> productosEncontrados = controlador.buscaProductosByTermino(termino);
        if (productosEncontrados.isEmpty()) {%>
<h2>No se encontraron resultados para el termino: "<%=termino%>"</h2>
<%} else {%>
<h2>Resultados para el termino: "<%=termino%>"</h2>
