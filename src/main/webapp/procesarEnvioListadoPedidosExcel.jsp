...
<html>
<head>
    <title>Envío efectuado con éxito</title>
...
<%
    ...
    if (correoEnvio == null) response.sendRedirect("index.jsp");
    else{
        controlador.adjuntaCorreosExcel(correoEnvio);%>
<div class="contenedor-confirmacion">
    <h2>Los pedidos han sido enviados a <b><%=correoEnvio%></b></h2>
    <h3>Puede volver al <a href="index.jsp">inicio</a> si así lo desea</h3>
</div>
   <%}%>
</body>
</html>
