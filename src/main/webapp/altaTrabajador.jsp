...
<div class="form-card">
    ...
    <form action="procesarAltaTrabajador.jsp" method="post">
        ...
        <div class="password-container">
            ...
            <button type="button" id="togglePasswordButton" onclick="togglePasswordVisibility()">Mostrar</button>
        </div>
        <input type="text" name="correo" placeholder="Introduce el correo del nuevo trabajador" required>
        <input type="text" name="telefono" placeholder="Introduce el teléfono del nuevo trabajador" maxlength="9" required>
        <button type="submit">Dar de alta al trabajador</button>
    </form>
</div>
<a href="index.jsp"><button class="boton-inicio">Cancelar y volver al inicio</button></a>
<%}else{
