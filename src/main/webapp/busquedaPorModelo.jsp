...
<html>
<head>
  <title>Resultados de la busqueda por modelo</title>
...
<%
  ...
  if (modelo == null){
    ...
    ArrayList<Producto> productosEncontrados = controlador.buscaProductosByModelo(modelo);
    if (productosEncontrados.isEmpty()){%>
<h2>No se encontraron resultados para el modelo: "<%=modelo%>"</h2>
<%}else{%>
<h2>Resultados para el modelo: "<%=modelo%>"</h2>
