...
<html>
<head>
    <title>Resultados de la busqueda por precio</title>
...
<%
    ...
    ArrayList<Producto> productosEncontrados = controlador.buscaProductosByPrecio(precioMin, precioMax);
    if (productosEncontrados.isEmpty()){%>
<h2>No se encontraron productos en el rango el precio (<%=precioMin%>€ - <%=precioMax%>€)</h2>
<%}else{%>
<h2>Productos encontrados en el rango el precio (<%=precioMin%>€ - <%=precioMax%>€)</h2>
