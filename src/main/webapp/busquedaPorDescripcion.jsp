...
<html>
<head>
  <title>Resultados de la busqueda por descripcion</title>
...
<%
  ...
  if (descripcion == null){
    ...
    ArrayList<Producto> productosEncontrados = controlador.buscaProductosByDescripcion(descripcion);
    if (productosEncontrados.isEmpty()){%>
<h2>No se encontraron resultados para la descripcion: "<%=descripcion%>"</h2>
<%}else{%>
<h2>Resultados para la descripcion: "<%=descripcion%>"</h2>
